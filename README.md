...
**Building**
cc65 can be used to build nesmon with the following commands.

```
$ git clone https://github.com/bitcores/nesmon.git && cd nesmon
$ ca65 nesmon.s
$ ld65 -C nes.cfg -o nesmon.nes nesmon.o
```
...
The location of the ECHO subroutine in memory has changed. In the 25-01-25 build it was at 844E (4E 84), now it is at 846D (6D 84). The location in memory may change again so always check and only use the example code with the most recent builds.
```
0: A9 b 0 b AA b 20 b 6D b 84 b E8 b 8A (RET)
8: 4C b 2 b 0 (RET)
0 (RET)
R (RET)
```
...
```
0: A9 b 8D b AA b 20 b 6D b 84 b E8 b E0 (RET)
...
This one jumps to the VBWAIT subroutine at address 8494 (94 84), this could also change in new builds.
```
0: A2 b 4 b 8E b 1 b 2 b 8E b 2 b 2 (RET)
8: A2 b 0 b 8E b 0 b 2 b 8E b 3 b 2 (RET)
10:E8 b 20 b 94 b 84 b 4C b A b 0 (RET)
0 (RET)
R (RET)
```
